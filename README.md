...
The contents of this repository are dual-licensed under the _[MIT](LICENSE-MIT) OR [Apache-2.0](LICENSE-APACHE_2.0)_ License. That means you can chose either the MIT licence or the
